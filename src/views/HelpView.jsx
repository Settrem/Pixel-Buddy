...
function HelpView() {
    return <div className="bg-[var(--theme-color)] relative gap-3 w-full h-full flex flex-col items-center p-5 overflow-scroll">
        ...
        <div className="text-xl sm:text-3xl text-left">
            
            <div className=" border-black p-1 mb-1">
        ...
        <div className="w-max text-2xl sm:text-4xl">
